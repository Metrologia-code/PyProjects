...
arg_parser.add_argument('-n', '--points', type=int, default=999999,
    help="Количество измерений (точек). По умолчанию: 999999 (фактически бесконечно)")

arg_parser.add_argument('-cp', '--canvaspoints', type=int, default=20,
    help="Количество точек по оси X на графике. По умолчанию: 20")
...
#---ЗАПУСК ЛОГГЕРА---
session = MeasurementSession(args, full_save_path, file_mode='w', canvas_points=args.canvaspoints)
