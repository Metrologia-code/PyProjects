...
#НУЖНО ВЫНЕСТИ АДРЕСА ПРИБОРОВ В ОТДЕЛЬНЫЙ ФАЙЛ (В ПАПКЕ Tonghui_libs) И ВЫЗЫВАТЬ ПО ИМЕНИ
...
if device_name == 'tonghui_TH1992B':
    ...
    tonghui_preset = {'1':'FDUCK_I', '2':'APL_I'}  # тут можно записывать в любом порядке
